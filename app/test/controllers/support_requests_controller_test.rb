...
class SupportRequestsControllerTest < ActionController::TestCase
  ...
  test "should create support_request" do
    assert_difference('SupportRequest.count') do
      post :create, support_request: { expired: @support_request.expired, justification: @support_request.justification, key: @support_request.key, provider: @support_request.provider, ttl: @support_request.ttl }
    end
  ...
  test "should update support_request" do
    patch :update, id: @support_request, support_request: { expired: @support_request.expired, justification: @support_request.justification, key: @support_request.key, provider: @support_request.provider, ttl: @support_request.ttl }
    assert_redirected_to support_request_path(assigns(:support_request))
  end
